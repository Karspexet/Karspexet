...
urlpatterns = [
    ...
    path("cancel/<show_id>/", views.cancel_reservation, name="cancel_reservation"),
    ...
    path("show/<show_slug>/booking_overview/", views.booking_overview, name="booking_overview"),
    path("show/<show_slug>/select_seats/", views.select_seats, name="select_seats"),
